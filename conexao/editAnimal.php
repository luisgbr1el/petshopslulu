		...
		<div class="editarCliente">
			...
			<h1>Editar cliente</h1>
				...
				<input type="text" name="nome" placeholder="Nome completo" minlength="10" value="<?php echo $data['Nome'] ?>" style="text-transform:uppercase" oninput="this.value = this.value.toUpperCase()" />
					<br> <br>
				Raça <br>
				<input type="text" name="raca" placeholder="Data de nasc." value="<?php echo $data['Raca'] ?>" />
				<br><br>
                Idade <br>

                <input type="tel" name="idade" required maxlength="11" placeholder="Novo CPF" value="<?php echo $data['Idade'] ?>" />
				<br>
