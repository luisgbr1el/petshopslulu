	...
	<form action="update.php" method="post">
		<div class="editarCliente">
			...
			<h1>Editar cliente</h1>
				...
				<input type="date" name="datanasc" placeholder="Data de nasc." value="<?php echo $data['datanasc'] ?>" />
				<br><br>

				CPF (somente dígitos) <br>
				<input type="tel" name="cpf" required maxlength="11" placeholder="Novo CPF" value="<?php echo $data['cpf'] ?>" />
				<br>
